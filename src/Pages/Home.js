    ...
    return (
        <div>
            ...
            <div className="mainmenu-div">
                ...
                <p className="mainmenu-p">Check Georgia's newspaper <br/> <br/> <a href="https://georgiatoday.ge/" target="_blank"><img src="http://getdrawings.com/free-icon/google-news-icon-69.png" width="250px" height="250px" className="PngMain"/></a></p>
            </div>
        </div>
    );
}
